...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-kde-plasma-theme-graphite"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-kde-plasma-theme-graphite/iso-profile
"
echo
