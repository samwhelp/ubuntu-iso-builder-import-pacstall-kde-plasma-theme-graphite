...
| `=` |
| [ubuntu-iso-builder-include-pacstall-kde-plasma-theme-graphite](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-kde-plasma-theme-graphite) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-kde-plasma-theme-graphite/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-kde-plasma-theme-graphite/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-kde-plasma-theme-graphite/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-import-pacstall-kde-plasma-theme-graphite](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-kde-plasma-theme-graphite)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-kde-plasma-theme-graphite.git
```


> change dir to `ubuntu-iso-builder-import-pacstall-kde-plasma-theme-graphite`

``` sh
cd ubuntu-iso-builder-import-pacstall-kde-plasma-theme-graphite
```
...
> change dir to `~/work/ubuntu-iso-builder-import-pacstall-kde-plasma-theme-graphite/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-import-pacstall-kde-plasma-theme-graphite/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-import-pacstall-kde-plasma-theme-graphite/iso-profile/dist`
